...
('Stay Physically Active', 'Aim for at least 150 minutes of moderate aerobic activity per week. Start slowly and gradually increase intensity. Consult your doctor before beginning any exercise program.', 'Exercise', 'High'),
('Manage Stress Effectively', 'Practice relaxation techniques like deep breathing, meditation, or yoga. Chronic stress can negatively impact heart health. Get adequate sleep (7-9 hours nightly).', 'Lifestyle', 'Medium'),
('Quit Smoking and Avoid Secondhand Smoke', 'Smoking damages blood vessels and increases heart disease risk. Seek support through cessation programs. Avoid exposure to secondhand smoke as well.', 'Lifestyle', 'Critical'),
('Limit Alcohol Consumption', 'If you drink, do so in moderation (up to 1 drink per day for women, 2 for men). Excessive alcohol can raise blood pressure and contribute to heart problems.', 'Lifestyle', 'Medium'),
('Maintain a Healthy Weight', 'Work towards a healthy BMI (18.5-24.9). Even a 5-10% weight loss can significantly improve heart health. Focus on sustainable lifestyle changes.', 'Weight', 'High'),
('Control Diabetes and Cholesterol', 'Keep blood sugar levels in target range if diabetic. Monitor cholesterol levels regularly. Follow your treatment plan and dietary recommendations.', 'Medical', 'High'),
('Stay Hydrated', 'Drink adequate water throughout the day (about 8 glasses). Proper hydration supports cardiovascular function. Limit sugary and caffeinated beverages.', 'Lifestyle', 'Medium'),
('Regular Medical Check-ups', 'Visit your cardiologist as recommended. Keep all follow-up appointments. Report any new or worsening symptoms promptly to your healthcare provider.', 'Medical', 'Critical');

-- =====================================================
-- CREATE DEFAULT USER PROFILE
-- =====================================================

INSERT INTO user_profiles (height, weight, age, gender) 
VALUES (170, 70, 30, 'other');
...
SELECT COUNT(*) as tips_count FROM heart_tips;
